...
const TailorDashboard = () => {
  ...
  const cards = [
    {
      title: "Profile",
      description: "Manage your personal & professional details",
      icon: "👤",
    ...
    {
      title: "Add / Edit Posts",
      description: "Showcase your latest work & designs",
      icon: "✏️",
    ...
    {
      title: "Gallery",
      description: "View your complete portfolio of creations",
      icon: "🖼️",
    ...
    {
      title: "Customers",
      description: "Manage your customer profiles & orders",
      icon: "👥",
    ...
    {
      title: "Orders",
      description: "Track and manage all your ongoing orders",
      icon: "📦",
  ...
  return (
    ...
    >
      ...
      <div className="relative px-12 pt-14 pb-10 overflow-hidden">
        ...
        <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-sky-500/5 rounded-full blur-3xl" />
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-sm max-w-md">
            Manage your profile, showcase your work, and grow your tailoring business — all in one place.
          </p>
        </div>
        {/* Decorative line */}
